...
<section class="boxes">
    <div>
        <div class="contain">
            <div class="donate">
                <a href="https://shieldoffaithidaho.com/what-i-offer/">
            ...
            <?php
            $query = 'SELECT * FROM ( SELECT * FROM videos WHERE vid_category = "fsjones" ORDER BY date DESC LIMIT 3) as r ORDER BY date DESC';
...
<div class="sermons-wrapper">
    <div class="row">
        ...
        <?php
        $countQuery = "SELECT COUNT(*) AS count FROM `videos` WHERE vid_category = 'fsjones'";
        $countResult = mysqli_query($conn, $countQuery);
        while ($row = mysqli_fetch_assoc($countResult)) {
            $countOutput = $row['count'];
        }

        $codeQuery = $mysqli->query("SELECT * FROM `videos` WHERE vid_category = 'fsjones' ORDER BY name ASC");
